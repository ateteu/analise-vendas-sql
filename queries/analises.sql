/*
Este arquivo contém as principais queries SQL utilizadas no projeto.

As consultas aqui estão organizadas por tipo de análise e têm como objetivo
demonstrar o uso de SQL na exploração e análise de dados de vendas.

Essas queries são executadas no notebook do projeto para geração
de resultados e visualizações.
*/
